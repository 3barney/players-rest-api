package com.barney.playerscore.controller
...
class PlayerControllerTest: PlayerScoreTestWithFongoAndMockMvc() {
    ...
    @Test
    fun postPlayerScoreTest() {
        logger.info("Begin postPlayerScore")
        ...
        logger.info("End postPlayerScore")
    }

    companion object {
        val logger = LoggerFactory.getLogger(PlayerControllerTest::class.java)
    }
}